...
function HelloBar() {
  return (
    ...
    >
      <b>Tsui Fresh v1.1</b> has been released with support for <b>automatic JSX</b>,
      {" "}
  ...
  return (
    <div class="grid md:grid-cols-3 gap-6 md:gap-14">
      <div class={item}>
        <FeatureIcons.Globe />
        <div class={desc}>
          <b>Just-in-time rendering</b> on the edge of Tsui.
        </div>
      </div>
      ...
      <div class={item}>
        ...
        <div class={desc}>
          <b>Zero runtime overhead</b>: no tsui JS is shipped to the client by
          default.
        </div>
      </div>
